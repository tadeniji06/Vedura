	...
	const opportunities = [
		{
			id: 1,
			title:
				"You're Buying Land in a Destination, Not Just a Location",
		...
		},
		{
			id: 2,
			title:
				"Freedom to Build with Purpose and Vision",
		...
		<section className='mt-16 px-4 max-w-7xl mx-auto'>
			...
			<div className='text-center mb-12'>
				...
				<p className='text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed max-w-3xl mx-auto'>
					At Vedura, you do not just own land. You
					own a part of something that is growing,
					evolving, and set to thrive.
				</p>
			</div>
				...
				{opportunities.map((opportunity) => (
					...
					>
						...
						<div className='p-6'>
							...
							<p className='text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed text-center'>
								{opportunity.body}
							</p>
						</div>
					</div>
