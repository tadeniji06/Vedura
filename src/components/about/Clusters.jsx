      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            <div className="text-center mb-12">
              <h3 className="text-2xl md:text-3xl font-bold text-primary-green mb-4">
                Residential clusters - The headquarters of peace and tranquility
              </h3>
            </div>
                ...
                >
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-primary-green">{cluster.req}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Price:</span>
                      <span className="font-bold text-2xl text-primary-green">{cluster.price}</span>
                    </div>
                  </div>
          ...
          <div>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Strategic business locations for growth and success
              </p>
            </div>
              ...
              {commercialClusters.map((cluster) => (
                ...
                >
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Price:</span>
                      <span className="font-bold text-xl text-primary-green">{cluster.price}</span>
                    </div>
                  </div>
        ...
        {/* <div className="text-center mt-16">
          <p className="text-gray-600 mb-6 text-lg">
            Need help choosing the right cluster for you?
          </p>
          <button className="bg-primary-green text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-primary-green/90 transition-colors duration-300">
