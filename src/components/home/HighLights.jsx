			...
			<div className='relative'>
				<div className='flex flex-col lg:flex-row items-center gap-0'>
					...
					>
						...
						>
							<motion.h1
								className='text-primary-green text-xxl lg:text-2xl font-semibold'
							...
							>
								Vedura Aqua Park- Where Fun Knows
								No Bounds
							</motion.h1>
							...
							>
								...
								where thrilling rides meet
								refreshing water fun – all in one
								amazing 4-hectare wonderland
