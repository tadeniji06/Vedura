    ...
    >
      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        ...
        >
          ...
          >
            Indulge in world-class amenities designed for the discerning
            few. Where luxury meets lifestyle, and every moment is
            extraordinary.
          </motion.p>
        </motion.div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {perkDetails.map((perk, index) => (
            <motion.div
              ...
              initial='rest'
              whileHover='hover'
              onHoverStart={() => setHoveredCard(perk.id)}
              ...
              <motion.div
                ...
                animate={
                  hoveredCard === perk.id
                    ...
                    : {
                        boxShadow: "0 0 0px rgba(30, 61, 54, 0)",
                      }
                }
                transition={{ duration: 0.3 }}
              />
        ...
        >
          ...
          <Link to={formLink} target='_blank'>
            <motion.button
              ...
              whileHover={{
                scale: 1.05,
                boxShadow: "0 20px 40px rgba(30, 61, 54, 0.3)",
                y: -3,
              }}
              whileTap={{ scale: 0.95 }}
            >
